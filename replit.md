...
- **Character Consistency System**: Ensures visual consistency of characters across all pages by using a detailed `mainCharacterDescription` and the cover image as a visual reference for AI image generation.
- **Image Style Control**: Detects style keywords in user prompts for AI image generation, defaulting to "vibrant and colorful children's book illustration."

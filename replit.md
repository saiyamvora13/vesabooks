...
- **Image Migration Tool**: Admin endpoint `/api/admin/migrate-images` to convert existing PNG storybook images to optimized JPEGs with atomic database updates, rollback safety, and comprehensive error handling.
